...
(function($) {
	...
	var yuri = window.location.search ? '<div><a href="javascript:window.history.back()">返回</a></div>' : '<div><a href="'+window.location.href+'?fullscreen">全屏</a></div>';
	var defaults = {
		velocity: 				1,
		interval: 				2500, 
		animation: 				'',
		...
		structure: 	 			  '<a href="#" class="prev_button">prev</a>'
								...
								+ '<span class="info_slide">'+yuri+'</span>'
